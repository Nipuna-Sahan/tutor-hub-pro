...
import { LogOut, Sparkles, Moon, Sun, Menu } from "lucide-react";
                ...
                <div className="flex items-center gap-2 md:gap-3 min-w-0">
                  ...
                  <div className="hidden sm:flex items-center gap-2">
                    ...
                    <div className="min-w-0">
                      <h2 className="text-xs md:text-sm font-bold font-display truncate">Student Portal</h2>
                      <p className="text-[10px] md:text-xs text-muted-foreground truncate">{student?.class}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-1.5 md:gap-2 shrink-0">
                  ...
                  <div className="hidden md:flex items-center gap-3 pl-3 border-l border-border/50">
                    <div className="text-right">
                      <p className="text-sm font-semibold truncate max-w-[120px] lg:max-w-none">{student?.name}</p>
